  ...
  return (
    <main className="min-h-screen bg-sand py-10 sm:py-14">
      <Container>
        ...
        {!overview && <Card className="mt-8 p-8"><h2 className="font-serif text-2xl">Choose a site to begin</h2><p className="mt-2 text-sm text-ink/60">Lifecycle and onboarding status will appear here.</p></Card>}
        {overview && (
