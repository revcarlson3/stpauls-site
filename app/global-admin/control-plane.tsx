...
type Overview = { site: { name: string; slug: string; location: string | null; status: string }; lifecycle: { status: string; onboardingStatus: string; currentStep: string | null }; health: { users: number }; recentActions: Array<{ id: string; summary: string; createdAt: string; actor: string }> };
