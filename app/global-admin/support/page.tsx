...
export default function GlobalAdminSupportPage() {
  ...
  async function submitReply() {
    ...
    await load();
    setMessage("Reply sent to the tenant.");
  }
  useEffect(() => {
