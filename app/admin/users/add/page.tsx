...
export default function AddUser() {
  ...
  return <main><Container className="py-10 sm:py-14">
    ...
    <form onSubmit={(event) => void submit(event)} className="mt-8 max-w-xl grid gap-4 rounded-2xl border border-ink/10 bg-white p-6 shadow-sm">
      ...
      <label className="grid gap-1 text-sm font-semibold">Temporary password<input name="password" required minLength={12} type="password" autoComplete="new-password" className="focus-ring rounded-lg border border-ink/15 px-3 py-2 font-normal" /></label>
