...
function reportPreset(reportType: MembershipReportType) {
  const presets: Record<MembershipReportType, { columns: string[]; conditions: Condition[]; sortKey: string; sortDirection: "asc" | "desc"; groupingKey: string }> = {
    ...
    "attendance-participation": { columns: ["name", "memberNumber", "eventTitle", "eventStartsAt", "eventType", "attendanceStatus", "participationType", "minutesParticipated"], conditions: [], sortKey: "eventStartsAt", sortDirection: "desc", groupingKey: "attendanceStatus" },
