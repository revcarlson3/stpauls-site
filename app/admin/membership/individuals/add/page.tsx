...
export default function AddIndividualPage() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const response = await fetch("/api/membership/individuals", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...Object.fromEntries(new FormData(event.currentTarget).entries()), customFieldValues, confirmDuplicate }) });
