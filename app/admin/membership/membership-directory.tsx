  ...
  return <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(18rem,0.8fr)_minmax(0,1.5fr)]">
    ...
    <section className="rounded-2xl border border-ink/10 bg-white p-6 shadow-sm">
      ...
      {selected ? <div className="mt-5 grid gap-6">
        <div className="flex justify-end"><a className="focus-ring rounded-full border border-coral px-4 py-2 text-sm font-semibold text-coral" href={`/admin/membership/individuals/${selected.id}/edit`}>Edit individual</a></div>
