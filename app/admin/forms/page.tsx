...
type FormRecord = { id: string; name: string; slug: string; status: string; enabled: boolean; audience?: string; audienceGroupIds?: unknown; definition: FormDefinition; notificationSettings?: Record<string, unknown>; exportSettings?: Record<string, unknown>; _count?: { submissions: number } };
...
const blank = { name: "", slug: "", status: "DRAFT", enabled: true, audience: "PUBLIC" };
...
export default function FormsPage() {
  ...
  function openBuilder(form?: FormRecord) {
    ...
    setBuilderOpen(true);
    setMeta(form ? { name: form.name, slug: form.slug, status: form.status, enabled: form.enabled, audience: form.audience === "MEMBERS" || form.audience === "GROUP" ? form.audience : "PUBLIC" } : blank);
