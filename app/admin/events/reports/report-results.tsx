...
type Report = { id: string; name: string; reportType: string; columns: { key: string; label: string }[]; sort?: { key: string; direction: "asc" | "desc" }[]; layout?: MembershipReportLayout };
