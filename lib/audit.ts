...
export const auditActivityTypes = ["user-created", "user-updated", "user-deleted", "invitation-created", "invitation-accepted", "invitation-resent", "invitation-revoked", "email-change-requested", "email-changed", "sessions-revoked", "group-created", "group-updated", "group-deleted", "membership-family-created", "membership-family-updated", "membership-family-removed", "membership-individual-created", "membership-individual-updated", "membership-individual-removed", "membership-note-created", "membership-note-updated", "membership-note-deleted", "membership-message-created", "membership-message-template-created", "membership-message-template-updated", "membership-message-template-deleted", "ai-image-generated"] as const;
