...
export const auditActivityTypes = ["user-created", "user-updated", "user-deleted", "invitation-created", "invitation-accepted", "invitation-resent", "invitation-revoked", "email-change-requested", "email-changed", "sessions-revoked", "group-created", "group-updated", "group-deleted", "membership-family-created", "membership-family-updated", "membership-family-removed", "membership-individual-created", "membership-individual-updated", "membership-individual-removed", "membership-note-created"] as const;
